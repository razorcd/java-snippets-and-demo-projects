...
//        - Algorithm1 and Algorithm2 will enter `waiting` state end release the `mutex` until the is an item in queue
//        - Algorithm3 will add data to `mutex` queue and implicitly notify all other threads. Monitor still not released at this point.
