...
public class Algorithm1 implements Runnable {
    ...
    public void run() {
        ...
        System.out.println(threadId + " Algorithm1 finished - App.globalInt: " + App.globalInt);
        System.out.println(threadId + " Algorithm1 finished - App.globalAtomicInt: " + App.globalAtomicInt);
        System.out.println(threadId + " Algorithm1 finished - App.globalIntForMutex: " + App.globalIntForMutex);
